...
test_default_charset(void)
{
    ...
    struct PP_Var cs = ppb_char_set_dev_get_default_char_set(instance);
...
test_to_utf16(void)
{
    ...
    printf("to utf16: all ASCII\n");
    {
        ...
        res_len = 7777;
        res = ppb_char_set_dev_char_set_to_utf16(instance, in, strlen(in), "UTF-8",
...
test_from_utf16(void)
{
    ...
    printf("from utf16: all ASCII\n");
    {
        ...
        res_len = 7777;
        res = ppb_char_set_dev_utf16_to_char_set(instance, in, sizeof(in) / sizeof(in[0]),
